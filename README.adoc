...
werden, immer auf volle Stunden gerundet.  Die Zeit wird dann von den Pflegnenden auf "read only" gesetzt und der/dem
Senior:in an einen gut sichtbaren Ort gestellt. Sobald die eingestellte Zeit erreicht ist, beginnt der Timer zu blinken.
